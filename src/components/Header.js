...
export const Header=()=>{
    ...
    //selector is a hook subcribing to the store 
        ...
        <div className="flex justify-between bg-blue-100 shadow-lg sm:bg-skyblue-500">
            ...
            <div className="flex items-center">
                <ul className="flex p-4 m-4">
                    ...
                    <li className="px-4 text-xl font-bold text-blue-500 uppercase"><Link className="link" to={"/cart"}>🛒{cartItems.length}</Link></li>
